    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div className="space-y-2">
          ...
          <p className="text-gray-500">Built on trust. Designed for your future.</p>
        </div>
      ...
      <Card className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
        ...
        <CardContent>
          <div className="text-3xl font-bold">{formatCurrency(profile.balance)}</div>
          <div className="mt-1 text-sm opacity-80">Account: {profile.account_number}</div>
        </CardContent>
      </Card>
          ...
          <Card>
            <CardContent className="py-6 text-center text-gray-500">
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs mt-1">Your secure financial journey starts here</p>
              </div>
            </CardContent>
          </Card>
        ) : (
